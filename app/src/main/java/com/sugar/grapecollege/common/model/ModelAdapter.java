 ...
 * 推荐使用：{@link com.sugar.grapecollege.common.utils.ModelTransformUtils}获取和转换
 */
...
public class ModelAdapter<T> {
    ...
    @Override public boolean equals(Object o) {
        return o != null && o instanceof ModelAdapter && model != null && model.equals(((ModelAdapter) o).model);
    }
}
