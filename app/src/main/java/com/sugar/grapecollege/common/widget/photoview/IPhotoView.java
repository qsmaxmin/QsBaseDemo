...
public interface IPhotoView {
    ...
    /**
     * Return the current scale shareType in use by the ImageView.
     *
    ...
    /**
     * requestFocusable then dispatch KeyEvent
     *
     * @param callback callback KeyEvent
     */
    void setOnKeyDownListener(KeyEvent.Callback callback);
}
